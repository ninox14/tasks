...
**Обратите внимание!** Если вы используете школьную сборку webpack, все html-файлы должны находиться на одном уровне с `index.html`, не вложенными в другие папки. Т.е. папку `tours` не создаёте, и файлы `index.html`, `tour1.html`, `tour2.html` и т.д. размещаете в папке `src`.
